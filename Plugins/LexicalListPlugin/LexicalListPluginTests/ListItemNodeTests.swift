...
class ListItemNodeTests: XCTestCase {
    ...
    func testItemCharacterWithNestedBulletList() throws {
    ...
    func testItemCharacterWithNestedNumberedList() throws {
        ...
        try editor.update {
            ...
            // Root level
            let list = ListNode(listType: .number, start: 1, withPlaceholders: true)
            ...
            // Nested level
            let nestedList = ListNode(listType: .number, start: 1, withPlaceholders: true)
